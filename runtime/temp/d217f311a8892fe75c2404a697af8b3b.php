<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"E:\PHPTools\www\leqiubaobei\public/../application/admin\view\video\question\edit.html";i:1536668848;s:70:"E:\PHPTools\www\leqiubaobei\application\admin\view\layout\default.html";i:1529292885;s:67:"E:\PHPTools\www\leqiubaobei\application\admin\view\common\meta.html";i:1529292885;s:69:"E:\PHPTools\www\leqiubaobei\application\admin\view\common\script.html";i:1529292885;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <input type="hidden" class="form-control" name="row[episode_id]" type="text" value="<?php echo $row['episode_id']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-answer" data-rule="required" class="form-control" name="row[answer]" type="text" value="<?php echo $row['answer']; ?>">
        </div>
    </div>
